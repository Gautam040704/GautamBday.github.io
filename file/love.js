(function(window){
    ...
    function animateHeart() {
        // Oscillate the scale factor between 0.9 and 1.1 for a heartbeat effect
        this.scaleFactor = 0.9 + 0.2 * Math.sin(Date.now() / 200);
    
        // Clear the canvas (if needed) before drawing the heart again
        this.tree.ctx.clearRect(0, 0, this.tree.ctx.canvas.width, this.tree.ctx.canvas.height);
    
        // Draw the heart with the updated scale
        drawHeart.call(this);
    
        // Request the next frame of the animation
        requestAnimationFrame(animateHeart.bind(this));
    }
